 ...
 */
final class Version20200422202013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD is_contact_form TINYINT(1) DEFAULT NULL, ADD ppa TINYINT(1) DEFAULT NULL, CHANGE phone phone VARCHAR(25) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE specialist CHANGE phone phone VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attachements CHANGE article_id article_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE client DROP is_contact_form, DROP ppa, CHANGE phone phone VARCHAR(25) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE questions CHANGE answered_by_id answered_by_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE schedule CHANGE client_id client_id INT DEFAULT NULL');

        $this->addSql('ALTER TABLE specialist CHANGE phone phone VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
